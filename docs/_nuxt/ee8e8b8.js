        ...
        function () {
          ...
          return r(
            ...
            [
              ...
              t._v(' '),
              r('div', { staticClass: 'max-w-4xl mx-auto sm:px-6 lg:px-8' }, [
                r(
                  'a',
                  {
                    ...
                    r(
                      ...
                      [
                        r(
                          ...
                          {
                            staticClass:
                              'w-6 h-6 text-gray-600 hover:text-gray-800',
                            attrs: {
                              xmlns: 'http://www.w3.org/2000/svg',
        ...
        [
          function () {
            ...
            return r(
              ...
              [
                r('h2', { staticClass: 'text-2xl leading-7 font-semibold' }, [
                  t._v('\n        Welcome to your Nuxt Application\n      '),
                ]),
                t._v(' '),
                r('p', { staticClass: 'mt-3 text-gray-600' }, [
                ...
                r(
                  ...
                  {
                    staticClass:
                      'mt-4 pt-4 text-gray-800 border-t border-dashed',
                  },
                  [
                    ...
                    r(
                      ...
                      [t._v('components/Tutorial.vue')]
                    ),
                    t._v(' and start coding in '),
                    r(
                      'code',
                      { staticClass: 'bg-gray-100 text-sm p-1 rounded border' },
                      [t._v('pages/index.vue')]
                    ),
                    t._v('. Have fun!\n      '),
                  ]
                ),
